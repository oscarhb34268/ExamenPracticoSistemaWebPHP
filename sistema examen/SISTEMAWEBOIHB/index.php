...
if (isset($_GET['buscar'])) {
    $buscar = $_GET['buscar'];
    $sql = "SELECT p.*, t.productotipos 
            FROM productos p
            INNER JOIN tipoproducto t ON p.tipo_id = t.id
            WHERE p.nombre LIKE '%$buscar%' OR p.id LIKE '%$buscar%' OR t.productotipos LIKE '%$buscar%'
...
<body>
    ...
    <div class="container-fluid custom-container">
        ...
        <div class="container-fluid">
            <input type="button" class="btn btn-success add-button" onclick="window.location.href='Vista/agregar.php'" name="mas" value="Nuevo Registro &#43;">
        </div>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($query)) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['productotipos'] ?></td>
                            <td><a href="Vista/ver.php?id=<?php echo $row['id'] ?>" class="btn btn-info">Ver &#128065;</a></td>    
                            <td><a href="Vista/actualizar.php?id=<?php echo $row['id'] ?>" class="btn btn-warning">Modificar &#9997;</a></td>
